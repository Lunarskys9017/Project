...
var useGameEventProvider = function (_a) {
    ...
    var _b = useState(), info = _b[0], setInfo = _b[1];
    var _c = useState(), event = _c[0], setEvent = _c[1];
    var _d = useState([]), requiredFeatures = _d[0], setFeatures = _d[1];
    function handleGameEvent(_a) {
        var info = _a.info, events = _a.events;
        info && setInfo(info);
        events && setEvent(events);
    }
    var registerToGepCallback = useCallback(function (_a) {
    ...
    var runGep = useCallback(function () {
        Overwolf.setRequiredFeatures(requiredFeatures, registerToGepCallback);
    }, [requiredFeatures, registerToGepCallback]);
    var setGameFeatures = useCallback(setFeatures, []);
    useEffect(function () {
...
var useWindow = function (name, _a) {
    var displayLog = _a.displayLog;
    var _b = useState(), owDeclaredWindow = _b[0], setOwDeclaredWindow = _b[1];
    var _c = useState(), owWindow = _c[0], setOwWindow = _c[1];
    var obtainDeclaredWindow = useCallback(function () { return __awaiter(void 0, void 0, void 0, function () {
...
var useDrag = function (currentWindowID, _a) {
    var displayLog = _a.displayLog;
    var _b = useState(currentWindowID), owWindow = _b[0], setOwWindow = _b[1];
    var _c = useState(null), initialMousePosition = _c[0], setMousePosition = _c[1];
    var _d = useState(false), isMouseDown = _d[0], setMouseDown = _d[1];
