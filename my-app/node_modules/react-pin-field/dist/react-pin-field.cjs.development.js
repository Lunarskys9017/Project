...
var reactUseBireducer = require('react-use-bireducer');
...
var _excluded = ["refs"];
var NO_EFFECTS = [];
var PROP_KEYS = ["autoFocus", "length", "validate", "format", "debug"];
...
function useEffectReducer(_ref) {
  ...
  return React.useCallback(function (effect) {
    switch (effect.type) {
      case "focus-input":
        {
...
var PinField = /*#__PURE__*/React.forwardRef(function (customProps, fwdRef) {
  ...
  var dispatch = reactUseBireducer.useBireducer(stateReducer, effectReducer, defaultState(props))[1];
  ...
  return React__default.createElement(React__default.Fragment, null, range(0, codeLength).map(function (idx) {
...
exports.HANDLER_KEYS = HANDLER_KEYS;
exports.IGNORED_META_KEYS = IGNORED_META_KEYS;
exports.NO_EFFECTS = NO_EFFECTS;
exports.PROP_KEYS = PROP_KEYS;
...
exports.pasteReducer = pasteReducer;
exports.stateReducer = stateReducer;
exports.useEffectReducer = useEffectReducer;
//# sourceMappingURL=react-pin-field.cjs.development.js.map
